...
CELERY_BROKER_URL = '{% if cookiecutter.celery_broker == "redis" %}redis://127.0.0.1:6379/0{% else %}amqp://guest@localhost//{% endif %}'
CELERY_RESULT_BACKEND = '{% if cookiecutter.celery_broker == "redis" %}redis://127.0.0.1:6379/0{% else %}rpc://{% endif %}'
